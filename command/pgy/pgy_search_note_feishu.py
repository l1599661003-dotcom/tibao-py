...
class GetPGYMediaAll:
    ...
    def handle(self):
        base_data = {"searchType":0,"column":"comprehensiverank","sort":"desc","pageSize":20,"brandUserId":"67bbea69000000000d009ec6","trackId":"kolMatch_a757945e774e4aa3909d9e284cef987c","marketTarget":None,"audienceGroup":[],"contentTag":["整体妆容","唇妆","底妆","美妆合集","香水","美妆其他","眼妆"],"personalTags":[],"gender":None,"location":None,"signed":-1,"featureTags":[],"fansAge":0,"fansGender":0,"accumCommonImpMedinNum30d":[],"readMidNor30":[],"interMidNor30":[100,-1],"thousandLikePercent30":[],"noteType":0,"notePriceLower":200,"notePriceUpper":3000,"videoPriceLower":200,"videoPriceUpper":3000,"inviteReply48hNumRatio":[0.8,1],"progressOrderCnt":[],"tradeType":"不限","tradeReportBrandIdSet":[],"excludedTradeReportBrandId":False,"estimateCpuv30d":[],"firstIndustry":"","secondIndustry":"","newHighQuality":0,"filterIntention":False,"flagList":[{"flagType":"HAS_BRAND_COOP_BUYER_AUTH","flagValue":"0"},{"flagType":"IS_HIGH_QUALITY","flagValue":"0"}],"activityCodes":[],"excludeLowActive":True,"fansNumUp":0,"excludedTradeReportBrand":False,"excludedTradeInviteReportBrand":False}
