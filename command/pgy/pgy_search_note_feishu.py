...
class GetPGYMediaAll:
    def __init__(self):
        self.headers = {
            ...
            "cookie": 'a1=19882f48bcap04qq1r777p9ggafrdrroz4abocygo50000339517; webId=e7111fec356dc781ca1d14d236afda9a; customerClientId=016216997022661; abRequestId=e7111fec356dc781ca1d14d236afda9a; x-user-id-creator.xiaohongshu.com=634cc30badd08a00019ee4e3; gid=yjYSKK8dd0uiyjYYJi4YD4SvS0U84AAyFWWW0klUjkk0iD28FfFFll888qqj2yW8DY2KKijK; web_session=0400698efe0fc8579efecd53ef3a4bd2bc26a6; x-user-id-ad-market.xiaohongshu.com=67bbea69000000000d009ec6; access-token-ad-market.xiaohongshu.com=customer.ad_market.AT-68c517561719769394855947z3wtukxckssgow61; webBuild=4.83.0; acw_tc=0a42543217611193665322556eceb84c72f76504730b95560ce66d2d4320cc; customer-sso-sid=68c5175639503778399027312h6fiebszoqmppjy; x-user-id-pgy.xiaohongshu.com=66c6e7c0000000001d022069; solar.beaker.session.id=AT-68c517563950382134902784udkqnnovew41r8os; access-token-pgy.xiaohongshu.com=customer.pgy.AT-68c517563950382134902784udkqnnovew41r8os; access-token-pgy.beta.xiaohongshu.com=customer.pgy.AT-68c517563950382134902784udkqnnovew41r8os; xsecappid=ratlin-carryon-merchant; loadts=1761119443096'
        }
    ...
    def handle(self):
        base_data = {"searchType":0,"column":"comprehensiverank","sort":"desc","pageSize":999,"brandUserId":"66c6e7c0000000001d022069","marketTarget":None,"audienceGroup":[],"contentTag":["科技数码"],"personalTags":[],"gender":None,"location":None,"signed":-1,"featureTags":["测评","合集","开箱"],"fansAge":0,"fansGender":0,"accumCommonImpMedinNum30d":[],"readMidNor30":[],"interMidNor30":[],"thousandLikePercent30":[],"noteType":2,"videoPriceLower":8000,"videoPriceUpper":30000,"progressOrderCnt":[],"tradeType":"不限","tradeReportBrandIdSet":[],"excludedTradeReportBrandId":False,"estimateCpuv30d":[],"firstIndustry":"","secondIndustry":"","newHighQuality":0,"filterIntention":False,"flagList":[{"flagType":"HAS_BRAND_COOP_BUYER_AUTH","flagValue":"0"},{"flagType":"IS_HIGH_QUALITY","flagValue":"0"}],"activityCodes":[],"excludeLowActive":False,"fansNumUp":0,"excludedTradeReportBrand":False,"excludedTradeInviteReportBrand":False}
