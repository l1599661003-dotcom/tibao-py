...
class WaicaiPGYSpider:
    ...
    def get_blogger_list_from_api(self):
        ...
        try:
            ...
            # 生产环境URL：
            api_url = f"https://tianji.fangpian999.com/api/admin/creatorBusiness/getNewerCreator?type=3&platform_id=1&page={self.config['PGY_LOGIN_CONFIG']['page']}&pageSize={self.config['PGY_LOGIN_CONFIG']['pageSize']}"
