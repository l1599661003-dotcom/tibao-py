...
if __name__ == '__main__':
    get_table_content()
    schedule.every().day.at('01:00').do(get_table_content)
    schedule.every().day.at('05:00').do(get_table_content)
    schedule.every().day.at('09:00').do(get_table_content1)
    schedule.every().day.at('11:00').do(get_table_content1)
    schedule.every().day.at('13:00').do(get_table_content1)
    # 如果你想在程序运行时一直保持调度
